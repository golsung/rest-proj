...
//    }
  ...
  public void shoudDisplayHomePageWhenMultipleMembersAreCreated() throws Exception {
    ...
    when(memberServiceMock.findAll()).thenReturn(mList);
...
//		member.setScore(30);
//		member.setId(12345L);
//      when(memberServiceMock.create(member)).thenReturn(member);
//        
//        
...
//        verify(memberServiceMock).create(argument.capture());
...
//		member.setScore(30);
//		member.setId(12345L);
//        when(memberServiceMock.findById(12345L)).thenReturn(member);
...
//    }
  ...
  public void shoudRedirectToHomeWhenAMemberIsDeleted() throws Exception {
      ...
      .andExpect(redirectedUrl("/"))
      .andDo(print());
      verify(memberServiceMock, never()).create(any());
